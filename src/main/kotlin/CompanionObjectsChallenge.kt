...
class Wizard(var firstName: String, var lastName: String) {
    ...
    companion object {
        val commonMagicalIngridients = mutableListOf<String>()
    }
}
...
fun main() {
    ...
    wizard.fullName = "Marko Peric"
    println(wizard.lastName)

    Wizard.commonMagicalIngridients.add("AAAA")
    Wizard.commonMagicalIngridients.add("EEEE")
    println(Wizard.commonMagicalIngridients)
}